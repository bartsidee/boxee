...
namespace PYXBMC
{
  ...
  PyDoc_STRVAR(setContentType__doc__,
               "setContentType(value) -- Sets a listitem content-type.\n"
               "\n"
               "value          : string - value of property.\n"
               "\n"
               "example:\n"
               "  - self.list.getSelectedItem().setContentType('video/mp4')\n");
  
  PyObject* ListItem_SetContentType(ListItem *self, PyObject *args, PyObject *kwds)
  {
    char *cLine = NULL;
    if (!self->item) return NULL;
    ...
    self->item->SetContentType(cLine ? cLine : "");
  ...
  PyMethodDef ListItem_methods[] = {
    ...
    {(char*)"setContentType", (PyCFunction)ListItem_SetContentType, METH_VARARGS, setContentType__doc__},
