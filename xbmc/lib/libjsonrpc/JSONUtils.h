...
namespace JSONRPC
{
  ...
  */
  ...
  static const int OPERATION_PERMISSION_ALL = (ReadData | ControlPlayback | ControlNotify | ControlPower | Logging | ScanLibrary | GUI);

  static const int OPERATION_PERMISSION_NOTIFICATION = (ControlPlayback | ControlNotify | ControlPower | Logging | ScanLibrary | GUI);
  ...
  protected:
     ...
     */
    static inline std::string NotificationFlagToString(const ANNOUNCEMENT::EAnnouncementFlag &notification)
    {
      switch (notification)
      {
      case ANNOUNCEMENT::AF_Playback:
        return "Playback";
      case ANNOUNCEMENT::AF_GUI:
        return "GUI";
      case ANNOUNCEMENT::AF_System:
        return "System";
      case ANNOUNCEMENT::AF_Library:
        return "Library";
      case ANNOUNCEMENT::AF_Other:
        return "Other";
      default:
        return "Unknown";
      }
