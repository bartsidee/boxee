...
void CGUIWindowMusicSongs::OnItemLoaded(CFileItem* pItem)
{
...
void CGUIWindowMusicSongs::Show(const CStdString &strPath)
{
  CGUIWindowMusicSongs *pWindow = (CGUIWindowMusicSongs *)g_windowManager.GetWindow(WINDOW_MUSIC_FILES);
  if (pWindow)
  {
