...
void CImageLoader::DoWork()
{
  ...
  if ((CUtil::IsHTTP(m_path) || file.IsPicture()) && !(file.IsZIP() || file.IsRAR() || file.IsCBR() || file.IsCBZ())) // ignore non-pictures
  {
    ...
    if (g_advancedSettings.m_useDDSFanart && file.IsType(".tbn"))
    {
      ...
      if (baseFolder1.Equals(m_path.Left(baseFolder1.GetLength())) || baseFolder2.Equals(m_path.Left(baseFolder2.GetLength())))
      {
        // switch to dds
    ...
    ///////////////////////////////////////////////////////////////////////////////
    // load picture with CPictureThumbLoader in order to use the cache mechanism //
    ///////////////////////////////////////////////////////////////////////////////

    file.SetThumbnailImage(loadPath);
    CPictureThumbLoader loader;
    if (loader.LoadItem(&file, true))
    {
      loadPath = file.GetThumbnailImage();
    }
