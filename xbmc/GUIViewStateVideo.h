...
class CGUIViewStateWindowVideoBoxeeDb : public CGUIViewStateWindowVideo
{
public:
  CGUIViewStateWindowVideoBoxeeDb(const CFileItemList& items);
...
class CGUIViewStateWindowVideoRssDirectory : public CGUIViewStateWindowVideo
{
public:
  CGUIViewStateWindowVideoRssDirectory(const CFileItemList& items);
...
class CGUIViewStateWindowVideoRssItems : public CGUIViewStateWindowVideo
{
public:
  CGUIViewStateWindowVideoRssItems(const CFileItemList& items);
