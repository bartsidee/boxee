...
//    virtual bool LoadImageWithCT(const char *, const char *, unsigned int, unsigned int, ImageInfo *)=0;
//    virtual bool CreateThumbnailWithCT(const char *, const char *,const char *, int, int, bool)=0;
...
//  DEFINE_METHOD5(bool, LoadImageWithCT, (const char * p1, const char * p2, unsigned int p3, unsigned int p4, ImageInfo * p5))
//  DEFINE_METHOD6(bool, CreateThumbnailWithCT, (const char * p1, const char * p2, const char * p3, int p4, int p5, bool p6))
...
//    RESOLVE_METHOD(LoadImageWithCT)
//    RESOLVE_METHOD(CreateThumbnailWithCT)
