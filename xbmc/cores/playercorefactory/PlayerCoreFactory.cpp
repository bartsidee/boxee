...
//      codec.DeInit();
  ...
  CLog::Log(LOGDEBUG, "CPlayerCoreFactory::GetPlayers: added %d players", (int)vecCores.size());
}
...
// BOXEE - START //
    CPlayerCoreConfig* flashplayer = new CPlayerCoreConfig("FLASHPlayer", EPC_FLASHPLAYER, NULL);
    flashplayer->m_bPlaysAudio = flashplayer->m_bPlaysVideo = true;
    s_vecCoreConfigs.push_back(flashplayer);
// BOXEE - END //
...
// BOXEE - START //
      if (type == "flashplayer" ) eCore = EPC_FLASHPLAYER;
// BOXEE - END //
