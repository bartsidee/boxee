...
bool CDVDAudio::Create(const DVDAudioFrame &audioframe, CodecID codec)
{
  ...
  m_pAudioDecoder = CAudioRendererFactory::Create(m_pCallback, audioframe.channels, audioframe.sample_rate, audioframe.bits_per_sample, false, codecstring, false, passthrough);
