...
#define __IS_STDIN_STREAM(stream)   (stream == stdin  || abs(stream->_file) == 0 )
#define __IS_STDOUT_STREAM(stream)  (stream == stdout || abs(stream->_file) == 1 )
#define __IS_STDERR_STREAM(stream)  (stream == stderr || abs(stream->_file) == 2 )
