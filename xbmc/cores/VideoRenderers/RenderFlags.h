...
#define RENDER_FLAG_TOP        0x01
#define RENDER_FLAG_BOT        0x02
#define RENDER_FLAG_BOTH (RENDER_FLAG_TOP | RENDER_FLAG_BOT)
...
#define CONF_FLAGS_EXTERN_IMAGE  0x40
#define CONF_FLAGS_OMX_TUNNELING 0x100
#define CONF_FLAGS_SMD_DECODING  0x200
#define CONF_FLAGS_EXTERN_IMAGE_WITH_VIDEO  0x400
