...
class CGUIDialogBoxeeBrowseLocalSubtitleSettings :
public CGUIDialogFileBrowser
{
public:
  CGUIDialogBoxeeBrowseLocalSubtitleSettings(void);
  virtual ~CGUIDialogBoxeeBrowseLocalSubtitleSettings(void);
