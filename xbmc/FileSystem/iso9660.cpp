...
HANDLE iso9660::OpenFile(const char *filename)
{
  ...
  *(pointer2 + 1) = 0;
  ...
  pContext->m_pBuffer = new unsigned char[CIRC_BUFFER_SIZE * BUFFER_SIZE];
...
//************************************************************************************
bool iso9660::ReadSectorFromCache(iso9660::isofile* pContext, DWORD sector, unsigned char** ppBuffer)
{
...
//************************************************************************************
long iso9660::ReadFile(HANDLE hFile, unsigned char *pBuffer, long lSize)
{
  bool bError;
  long iBytesRead = 0;
