...
namespace XFILE
{
  ...
  public:
    ...
    virtual bool OpenForWrite(const CURI& url, bool bBinary = true, bool bOverWrite = false);
  ...
  protected:
    IFileSystem *GetFileSystem(const CURI &url);
    CStdString   GetPath(const CURI& url);
