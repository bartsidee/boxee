...
#ifdef WIN32
  static void CSpecialProtocol::SetMyVideosPath(const CStdString &dir);
  static void CSpecialProtocol::SetMyMusicPath(const CStdString &dir);
  static void CSpecialProtocol::SetMyPicturesPath(const CStdString &dir);
#endif
...
private:
  ...
  static CCriticalSection m_mapPathsGuard;
  static std::map<CStdString, CStdString> m_cachePaths;
};
