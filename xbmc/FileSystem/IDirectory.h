...
public:
  ...
  /*!
   ...
   \sa CFactoryDirectory
   */
  virtual bool GetDirectory(const CFileItem* pItem, CFileItemList &items); 
...
protected:
  ...
  bool m_requestCanceled;    ///< If true the request for GetDirectory was canceled (defaults to false)
  CCriticalSection m_requestCancellock;
