...
class CGUIViewStateWindowMusicSongsBoxeeDb : public CGUIViewStateWindowMusic
{
public:
  CGUIViewStateWindowMusicSongsBoxeeDb(const CFileItemList& items);
...
class CGUIViewStateMusicShoutcastGenre : public CGUIViewStateWindowMusic
{
public:
  CGUIViewStateMusicShoutcastGenre(const CFileItemList& items);
...
class CGUIViewStateMusicLastFMTags : public CGUIViewStateWindowMusic
{
public:
  CGUIViewStateMusicLastFMTags(const CFileItemList& items);
...
class CGUIViewStateWindowMusicRssDirectory : public CGUIViewStateWindowMusic
{
public:
  CGUIViewStateWindowMusicRssDirectory(const CFileItemList& items);
...
class CGUIViewStateWindowMusicRssItems : public CGUIViewStateWindowMusic
{
public:
  CGUIViewStateWindowMusicRssItems(const CFileItemList& items);
