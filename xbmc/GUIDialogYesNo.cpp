...
bool CGUIDialogYesNo::ShowAndGetInput(int heading, int line0, int line1, int line2, int iNoLabel, int iYesLabel, bool& bCanceled, unsigned int autoCloseTime, int defaultButton)
{
...
{
  CStdString empty("");
  return ShowAndGetInput(heading,line0,line1,line2,empty,empty);
}
...
{
  CStdString empty("");
  return ShowAndGetInput(heading,line0,line1,line2,empty,empty,bCanceled);
}
...
{
  bool bDummy;
  return ShowAndGetInput(heading,line0,line1,line2,noLabel,yesLabel,bDummy);
}

bool CGUIDialogYesNo::ShowAndGetInput(const CStdString& heading, const CStdString& line0, const CStdString& line1, const CStdString& line2, const CStdString& noLabel, const CStdString& yesLabel, bool& bCanceled)
{
  CGUIDialogYesNo *dialog = (CGUIDialogYesNo *)g_windowManager.GetWindow(WINDOW_DIALOG_YES_NO);
  if (!dialog) return false;
  dialog->SetHeading(heading);
