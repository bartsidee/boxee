...
/* NAME
 ...
 output.  */
int FuzzyStrCmp::diag (int xoff, int xlim, int yoff, int ylim, int minimal, struct partition *part)
{
...
void FuzzyStrCmp::compareseq (int xoff, int xlim, int yoff, int ylim, int minimal)
{
...
double FuzzyStrCmp::fstrcmp (const char *string1, const char *string2, double minimum)
{
  int i;
...
{
  FuzzyStrCmp fuzzy;
  return fuzzy.fstrcmp(__s1, __s2, __minimum);
}
