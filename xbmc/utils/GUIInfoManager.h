...
#define PLAYER_ACTION_NEXT           2
#define PLAYER_ACTION_PREV           4
#define PLAYER_ACTION_STOP           8
#define PLAYER_ACTION_PAUSE          16
...
#define BOXEE_NEW_VERSION            83
#define BOXEE_QUEUE_ITEMS            84
#define BOXEE_MOUSE_ENABLED          85
#define BOXEE_HAS_INTERNET_CONNECTION 86
...
#define CONTAINER_IS_SORT_ABC       321
#define CONTAINER_IS_EMPTY          322
#define CONTAINER_IS_LOADING        323
#define CONTAINER_IS_LOADED         324
...
#define PLAYLIST_NEXTTITLE          397
#define PLAYLIST_PREVTITLE          398
...
#define INTEGER_HOUR_BETWEEN        423

#define URL_ENCODE                  430
#define URL_DECODE                  441
#define FORMAT_TIME                 451
...
#define APP_STRING                  610
#define APP_BOOL                    611
#define APP_IMPLODE                 612
#define APP_PARAM                   613
...
#define SYSTEM_TIME_NO_AMPM         717
#define SYSTEM_TIME_IS_AMPM         718
...
#define KEYBOARD_NATIVE_DESC        832
#define KEYBOARD_HAS_CAPS           833
#define KEYBOARD_IS_RTL             834
#define KEYBOARD_MAX_ID             835
...
#define WINDOW_CHECK_INT_PROPERTY   9991
...
//Boxee
#define LISTITEM_PICTURE_DESCRIPTION   (LISTITEM_START + 70)
#define LISTITEM_PICTURE_CAMERA_MAKE   (LISTITEM_START + 71)
#define LISTITEM_PICTURE_CAMERA_MODEL  (LISTITEM_START + 72)
#define LISTITEM_PICTURE_COMMENT       (LISTITEM_START + 73)
#define LISTITEM_PICTURE_SOFTWARE      (LISTITEM_START + 74)
#define LISTITEM_PICTURE_APERTURE      (LISTITEM_START + 75)
#define LISTITEM_PICTURE_FOCAL_LENGTH  (LISTITEM_START + 76)
#define LISTITEM_PICTURE_FOCUS_DIST    (LISTITEM_START + 77)
#define LISTITEM_PICTURE_EXPOSURE      (LISTITEM_START + 78)
#define LISTITEM_PICTURE_EXPOSURE_TIME (LISTITEM_START + 79)
#define LISTITEM_PICTURE_EXPOSURE_BIAS (LISTITEM_START + 80)
#define LISTITEM_PICTURE_EXPOSURE_MODE (LISTITEM_START + 81)

#define LISTITEM_ISEVEN                (LISTITEM_START + 82)
#define LISTITEM_ISODD                 (LISTITEM_START + 83)
#define LISTITEM_OFFSET                (LISTITEM_START + 84)

#define LISTITEM_HAS_VIDEO_INFO            (LISTITEM_START + 110)
...
#define LISTITEM_INFO_COUNT         (LISTITEM_END - LISTITEM_START)

// the multiple information vector
#define MULTI_INFO_START              40000
#define MULTI_INFO_END                41000 // 1000 references is all we have for now

#define CURRENTLY_PLAYING_ITEM_START  63000
#define CURRENTLY_PLAYING_ITEM_END    (CURRENTLY_PLAYING_ITEM_START + LISTITEM_INFO_COUNT)

#define NEXT_PLAYING_ITEM_START  73000
#define NEXT_PLAYING_ITEM_END    (NEXT_PLAYING_ITEM_START + LISTITEM_INFO_COUNT)
...
#define INFOFLAG_LISTITEM_SELECTED    ((uint32_t) (1 << 27))  // Selected ListItem lookups
...
public:
  ...
  const CFileItem & GetCurrentItem() const;
  ...
  bool IsPlayerActionAllowed(int iPlayerAction);
  void LockPlayerAction(int iActionMask);
  ...
  void UpdateFPS();
  inline float GetFPS() const { if (m_fps == 0.0) return 60; return m_fps; };
