...
CNetworkInterfacePtr CNetwork::GetFirstConnectedInterface()
{
   vector<CNetworkInterfacePtr> ifaces = GetInterfaceList();
   vector<CNetworkInterfacePtr>::const_iterator iter = ifaces.begin();
...
CNetworkInterfacePtr CNetwork::GetInterfaceByName(const CStdString& name)
{
   vector<CNetworkInterfacePtr> ifaces = GetInterfaceList();
   vector<CNetworkInterfacePtr>::const_iterator iter = ifaces.begin();
   while (iter != ifaces.end())
