...
long long cas2(volatile long long* pAddr, long long expectedVal, long long swapVal)
{
  throw "cas2 is not implemented on arm!";
}
...
long AtomicIncrement(volatile long* pAddr)
{
  throw "AtomicIncrement is not implemented on arm!";
}
...
long AtomicAdd(volatile long* pAddr, long amount)
{
  throw "AtomicAdd is not implemented on arm!";
}
...
long AtomicDecrement(volatile long* pAddr)
{
  throw "AtomicDecrement is not implemented on arm!";
}
...
long AtomicSubtract(volatile long* pAddr, long amount)
{
  throw "volatile long* pAddr, long amount is not implemented on arm!";
}
