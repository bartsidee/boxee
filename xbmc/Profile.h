...
public:
  ...
  const CStdString& getID() const { return _id;}
  ...
  const CStdString& getLastLockCode() const { return _strLastLockCode;}
  LockType getLockMode() const { return _iLockMode; }
  const CStdString& getAdultLockCode() const { return _strAdultLockCode;}
  ...
  bool rememberPassword() const { return _bRememberPassword; }
  bool adultLocked() const { return _bLockAdult; }

  void setName(const CStdString& name) {_name = name;}
  void setID(const CStdString& id) {_id = id;}
  ...
  void setLastLockCode(const CStdString& strLastLockCode) { _strLastLockCode = strLastLockCode; }
  ...
  void setAdultLocked(bool bLocked) { _bLockAdult = bLocked; }
  void setAdultLockCode(const CStdString& strLockCode) { _strAdultLockCode = strLockCode; }  
  ...
  bool _bRememberPassword;
  
  bool _bLockAdult;
  CStdString _strAdultLockCode;
};
