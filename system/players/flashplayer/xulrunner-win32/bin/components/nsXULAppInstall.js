...
//@line 41 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 235 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 265 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
      aLeafName = appName;
//@line 270 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
    }
...
//@line 341 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
...
//@line 348 "c:\Work\mozilla-1.9.1\xulrunner\setup\nsXULAppInstall.js"
  }
};
