...
rem	CONFIG START
  ...
  set OPTS_EXE="..\VS2008Express\XBMC for Windows.sln" /build "Debug (SDL)"
	set CLEAN_EXE="..\VS2008Express\XBMC for Windows.sln" /clean "Debug (SDL)"
	set EXE= "..\VS2008Express\XBMC\Debug (SDL)\BOXEE.exe"
...
:COMPILE_EXE
  ...
  %NET% %OPTS_EXE%
  IF NOT EXIST %EXE% (
  	set DIETEXT="XBMC.EXE failed to build!  See ..\vs2008express\XBMC\Debug (SDL)\BuildLog.htm for details."
  	goto DIE
  )   
  ECHO Done!
  ECHO ------------------------------------------------------------
...
:COMPILE_NO_CLEAN_EXE
  ...
  %NET% %OPTS_EXE%
  IF NOT EXIST %EXE% (
  	set DIETEXT="XBMC.EXE failed to build!  See ..\vs2008express\XBMC\Debug (SDL)\BuildLog\BuildLog.htm for details."
  	goto DIE
  )
  ECHO Done!
  ECHO ------------------------------------------------------------
