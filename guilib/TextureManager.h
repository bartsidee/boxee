...
public:
  ...
  void SetPlaceHolder(bool bPlaceHolder);
  void SetName(const CStdString& textureName);
protected:
  bool m_bPlaceHolder;
...
public:
  ...
  void Dump() const;
  uint32_t GetMemoryUsage() const;
  uint32_t GetNumOfTextures() const;
  void Flush();
  ...
  void PinTexture(const CStdString& textureName);
  void LoadPinnedTextures();
