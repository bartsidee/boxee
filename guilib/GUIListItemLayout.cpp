...
{
  m_group.QueueAnimation(animType);
}
...
bool CGUIListItemLayout::HasAnimation(ANIMATION_TYPE anim)
{
  return m_group.HasAnimation(anim);
}
...
void CGUIListItemLayout::AddAnimation(const CAnimation &animation)
{
