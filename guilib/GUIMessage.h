...
//Boxee
#define GUI_MSG_ITEM_LOADED  83 // issued when item data is loaded or updated
#define GUI_MSG_LOADING      84 // issued when list, container or window is in loading state
#define GUI_MSG_LOAD_FAILED  85 // issued when list, container or window load failed
#define GUI_MSG_MARK_ITEM    86
#define GUI_MSG_UNMARK_ITEM    87
#define GUI_MSG_MARK_ALL_ITEMS    88
#define GUI_MSG_UNMARK_ALL_ITEMS    89
#define GUI_MSG_SET_FILENAME 90
#define GUI_MSG_BG_PICTURE 91
#define GUI_MSG_RELOAD_CONTENT 92

#define GUI_MSG_GET_FOCUS   93
#define GUI_MSG_GET_VISIBLE 94
#define GUI_MSG_GET_ENABLED 95

#define GUI_MSG_GET_LABEL  96
#define GUI_MSG_GET_LABEL2 97
