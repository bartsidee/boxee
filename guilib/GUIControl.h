...
public:
  ...
  XBMC_FORCE_INLINE bool IsVisibleFromSkin() const { return m_visibleFromSkinCondition; };
  ...
  int GetVisibleCondition();
  XBMC_FORCE_INLINE int GetVisibleCondition() const { return m_visibleCondition; };
  ...
  XBMC_FORCE_INLINE const std::vector<CAnimation> &GetAnimations() const { return m_animations; }
  void AddAnimation(const CAnimation &animation);
