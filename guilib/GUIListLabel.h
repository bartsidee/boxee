...
public:
  ...
  void SetScrolling(bool scrolling); // will cause the label to ALWAYS scroll (tag name <scroll>)
  void SetWrap(bool bWrap);          // will cause the label text to wrap     (tag name <wrapmultiline>)
  void SetScrollOnFocus(bool bScrollOnfocus); // scroll when item is in focus (tag name <scrollonfocus>)
