...
void CGUIAudioManager::Stop()
{
  ...
  if (m_actionSound)
  {
    ...
    // Commented out, cause 4 sec delay in shutdown
...
{
#ifdef __APPLE__
  // under apple - we need to restart the audio unit (might have been closed at end of movie playback).
  // this is just when gui sounds are on and movie finished playing (restoring sound)
